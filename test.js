...
// - Add a test for the "since" option when the date is not empty and the date is in the future or in the wrong format

//***/ Commits tests
// - Add a test for an invalid line in a commit
// - Add test for when the file already exists and the last date is expected to be valid